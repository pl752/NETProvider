...
internal sealed class FesDatabase : DatabaseBase {
		...
		public override StatementBase CreateStatement() => new FesStatement(this);

		public override StatementBase CreateStatement(TransactionBase transaction) => new FesStatement(this, transaction as FesTransaction);
		...
		internal void ProcessStatusVector(IntPtr[] statusVector) => StatusVectorHelper.ProcessStatusVector(statusVector, Charset, WarningMessage);
